...
def sistemaFuzzy(calificacion, tiempo, ayuda, dificultad):
	...
	# Tiempo
	T_1 = FuzzySet(function=Trapezoidal_MF(a=0, b=0, c=5, d=6), term="poco")
	T_2 = FuzzySet(function=Trapezoidal_MF(a=6, b=6.5, c=7, d=7.5), term="medio")
	T_3 = FuzzySet(function=Trapezoidal_MF(a=7.5, b=8, c=9, d=9), term="mucho")
	...
	print('Dificultad anterior: ' + str(dificultad))
	print('Dificultad siguiente: ' + str(difSig))
